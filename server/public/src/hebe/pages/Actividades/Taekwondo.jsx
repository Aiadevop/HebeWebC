  ...
  return (
    <>
      ...
      <div className='taekwondoContainer'>
        ...
        <img className='taekwondoImg' src='public\resources\img\taekwondoweb.png'></img>
      </div>

      <div className='taekwondoContainerMovil'>
      <h1 className='taeh1 movil'>Taekwondo Hebe Moaña</h1>
      <br/>
        <img className='taekwondoImgx ' src='public\resources\img\taekwondoweb.png'></img>
        <div className='taekwondo'>
      ...
      <div className='horariocontainer'>
        <div>
          ...
          <br />
          <img className='taehorario' src='public\resources\img\horarios\horarioTaeHebe.png'></img>
        </div>
        <div>
          <br />
