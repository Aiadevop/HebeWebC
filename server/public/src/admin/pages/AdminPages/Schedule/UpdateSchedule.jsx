...
export const UpdateSchedule = () => {
  ...
  async function onSubmitUpdateSchedule(event) {
    ...
    try {
      ...
      if (diaInput !== "" || undefined) {
        _datos.dia = diaInput;
      }

      if (desdeInput !== "" || undefined) {
        _datos.desde = desdeInput;
      }

      if (hastaInput !== undefined) {
        _datos.hasta = hastaInput;
      }

      if (salaInput !== "" || undefined) {
        _datos.sala = salaInput;
      }

      if (actividadInput !== "" || undefined) {
  ...
  return (
    <>
      <br />
      <form className='formAdmin' onSubmit={onSubmitUpdateSchedule} >
